import Augmentation as Aug  # На доработке
import Dataset as Dt
import MachineLearning as ML
from sklearn.metrics import roc_auc_score, accuracy_score, precision_recall_fscore_support, classification_report

USE_EXTRA_YANDEX_DATASET = False

train_df, val_df = Dt.CreateNecessaryDataset(USE_EXTRA_YANDEX_DATASET)  # False если не нужно подключать датасет Яндекса
